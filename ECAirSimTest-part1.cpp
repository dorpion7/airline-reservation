...
static void Test1()
{
    ...
    // SIMPLY COMMENTING THIS OUT SO MY STUFF WORKS FOR NOW
    // DONT ACTUALLY NEED THE PREFERENCES TO WORK YET
    #if 0
    sim.PreferLowPrice();
    sim.PreferShortTime();
    #endif 
...
static void Test2()
{
    ...
    // Flight to/from BDL: not many flights; sigh... stop trying to be all cute with me
