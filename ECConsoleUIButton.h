...
public:
    ...
    ECConsoleUIButton(int xUL, int yUL, int xLR, int yLR, const std::string &textButton, ECConsoleUIListBox &box1, ECConsoleUIListBox &box2, ECConsoleUIListBox &box3, ECAirlineSimulator &sim );
